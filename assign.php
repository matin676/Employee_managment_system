...
$sql = "SELECT id, firstName, lastName,  points FROM employee, rank WHERE rank.eid = employee.id";
                ...
                <div class="card-body">
                    ...
                    <form action="process/assignp.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <div div class="rs-select2 js-select-simple select--no-search">
                                <select name="eid" required id="EmpID" style="border-radius: 5px;border: none; width:5rem; font-size: 1rem;font-family: 'Ubuntu', sans-serif;font-weight: lighter">
