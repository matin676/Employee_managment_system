...
<body>
    <nav class="navbar">
        <div class="max-width">
            ...
            <ul class="menu">
                <li><a href="aloginwel.php" class="menu-btn">Home</a></li>
                <li><a href="addemp.php" class="menu-btn">Add Employee</a></li>
                <li><a href="viewemp.php" class="menu-btn">View Employee</a></li>
